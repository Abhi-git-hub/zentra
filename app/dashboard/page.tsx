...
export default function ScenarioSelectionPage() {
  return (
    <main className="flex flex-col min-h-[calc(100vh-56px)] p-6 lg:p-12 items-center">
      <div className="w-full max-w-[1200px] mb-8 text-center md:text-left">
        <h1 className="text-3xl font-bold mb-2">Select a Scenario</h1>
      ...
      <motion.div 
        ...
        initial="hidden"
        animate="show"
        className="w-full max-w-[1200px] flex flex-col xl:flex-row gap-6 md:gap-8 justify-center"
      >
